# 修改版 #
由于自己做英文毕设，针对自己的情况做了一些修改和调整，后续遇到问题会继续更新。
- 修正了英文模式下，\pic 和 \pictable 环境中依然显示中文的“图”“表” (参考 https://github.com/shifujun/UESTCthesis/issues/102)
- 调整了一些文件夹位置，自己看上去更整洁，把编译脚本放在`template/compiles`中。
- 针对Mac下因缺少某些字体编译失败，把缺少的字体补充在 `template/font` 文件夹中，编译时自行复制到目录下。
# 最新版本：v1.2.7 #
升级前请阅读下方的更新日志。
